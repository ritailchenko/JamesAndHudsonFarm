...
if ( ! defined('ENV'))
{
	$production  = 'jamesandhudsonfarm.com';
	$staging     = 'jamesandhudsonfarm.elemento.biz/';
	$development = 'jamesandhudsonfarm.localhost:3000/';
	$local       = 'jamesandhudsonfarm.localhost:3000/';
